import { createElement, memo, forwardRef, useRef, useEffect } from "react";
import { Shader, ShaderHandle, ShaderProps } from "./Shader";

// Reversed from Clerk

const MemoizedShader = memo(
  forwardRef<ShaderHandle, ShaderProps>((props, ref) => createElement(Shader, { ...props, ref }))
);
