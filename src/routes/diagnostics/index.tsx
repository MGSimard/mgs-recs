  ...
  return (
    <>
      <Section
        ...
        features={[
          "Detects React performance issues automatically",
          "No code changes required, drop-in usage",
          "Highlights components needing optimization",
          "Works via script tag, npm, CLI, or extension",
          "Supports Next.js, Vite, Remix, CRA, and more",
          "Visual cues for unnecessary renders",
          "Actionable insights directly in your workflow",
          "Open source and free for all projects",
        ]}
        issues={[]}></Section>
      ...
      <Section
        ...
        features={[
          "Performance audits for speed and loading times",
          "Accessibility audits for inclusive design",
          "Best practices checks for modern web standards",
          "SEO audits for search engine optimization",
          "Progressive Web App (PWA) audits",
          "Detailed reports with actionable suggestions",
          "Runs in Chrome DevTools, CLI, Node, or web UI",
      ...
      <Section
        ...
        features={[
          "Error monitoring with alerts and stack traces",
          "Distributed tracing for performance visibility",
          "Session replay for visual debugging",
          "Continuous profiling for bottlenecks",
          "Uptime and cron monitoring",
          "Code coverage and PR feedback",
          "User feedback linked to errors",
          "Integrations with GitHub, Slack, Jira, etc.",
          "100+ platform and framework support",
          "Fast setup, cloud or self-hosted",
        ]}
        issues={[]}></Section>
      ...
      <Section
        ...
        features={[
          ...
          "Works with both localhost and websites",
          "Generates previews for X, Discord, Google, Facebook",
          "Bypasses CORS and caching limitations",
          "Command-line tool, no deployment required",
