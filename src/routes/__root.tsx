...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://mgs-recs.netlify.app/" },
      ...
      { property: "og:image", content: "https://mgs-recs.netlify.app/metadata/opengraph-image.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "600" },
      // Twitter
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:url", content: "https://mgs-recs.netlify.app/" },
      ...
      { name: "twitter:image", content: "https://mgs-recs.netlify.app/metadata/twitter-image.png" },
    ],
    links: [
      { rel: "stylesheet", href: globalCss },
      { rel: "stylesheet", href: fontsCss },
      { rel: "canonical", href: "https://mgs-recs.netlify.app/" },
      ...
      <body>
        <Providers>
          ...
          <SidebarInset className="max-w-screen-xl mx-auto">
            <Header />
            <main className="@container flex flex-1 flex-col gap-12 p-8">{children}</main>
          </SidebarInset>
        </Providers>
        <Scripts />
      </body>
