  ...
  return (
    <>
      <Section
        ...
        features={[
          "High-performance SQL query builder",
          "Zero dependencies, serverless-ready",
          "Type-safe schema definitions",
          "Prepared statements support",
          "Supports PostgreSQL, MySQL & SQLite",
          "Efficient relational queries (no n+1)",
          "Visual database explorer (Drizzle Studio)",
          "Automatic migrations",
          "First-class TypeScript support",
        ]}
        issues={["Multi-project schema support is consistently bugged"]}></Section>
      ...
      <Section
        ...
        issues={["Simpler, but less features and control than Drizzle", "Slower than Drizzle"]}></Section>
    </>
  );
}
