    ...
    <>
      <Section
        ...
        features={[
          ...
          "Reusable actions and workflow templates",
          "GitHub-hosted and self-hosted runners",
          "Integrated secrets and environment management",
      ...
      <Section
        ...
        features={[
          "AI-powered code reviews in PRs and IDE",
          "Context-aware feedback with codebase analysis",
          "Supports all major languages and platforms",
          "One-click fixes and actionable suggestions",
          "Customizable review preferences and learnings",
          "Integrates with GitHub, GitLab, Azure, Bitbucket",
          "Zero data retention and enterprise-grade security",
        ]}
        issues={["In-editor comments return after clicking ignore"]}></Section>
    </>
  );
}
